// Serverless proxy for Salebot create_client
// Deploy on Vercel/Cloudflare. Set env SALEBOT_API_KEY.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!apiKey) return res.status(500).json({ error: 'SALEBOT_API_KEY not configured' });
